...
class PhotoItemWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.size_combo.setStyleSheet("QComboBox { font-size: 10px; min-height: 22px; }")
        ...
        self.qty_spin.setFixedWidth(45)
        self.qty_spin.setStyleSheet("QSpinBox { font-size: 10px; min-height: 22px; }")
